...
describe('UserPolicy', function (): void {
    ...
    it('allows view for self or with permission', function (): void {
    ...
    it('allows create only with permission', function (): void {
        $policy = new UserPolicy;
    ...
    it('blocks update for super-admin target', function (): void {
        $policy = new UserPolicy;
    ...
    it('allows update for self or with permission', function (): void {
        $policy = new UserPolicy;
        $owner = UserFactory::new()->createOne();
    ...
    it('blocks delete for self and super-admin', function (): void {
        $policy = new UserPolicy;
        $actor = UserFactory::new()->createOne();
