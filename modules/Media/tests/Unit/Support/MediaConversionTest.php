...
describe('MediaConversion builder', function () {
    it('accepts valid width height fit format and quality', function () {
    ...
    it('rejects out of bounds width', function () {
    ...
    it('rejects out of bounds height', function () {
    ...
    it('rejects unknown fit values', function () {
    ...
    it('rejects out of bounds quality', function () {
...
describe('MediaConversion modifiers', function () {
    it('parses ipx style modifiers with fit', function () {
    ...
    it('parses slash style modifiers with fit', function () {
    ...
    it('changes derived path when fit differs', function () {
