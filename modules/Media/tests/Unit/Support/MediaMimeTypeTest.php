...
describe('MediaMimeType support', function () {
    it('sniffs image bytes regardless of the client mime', function () {
    ...
    it('sniffs pdf and text buffers', function () {
    ...
    it('flags executable and markup content as blocked', function () {
    ...
    it('matches extensions against sniffed mimes and fails open on unknowns', function () {
