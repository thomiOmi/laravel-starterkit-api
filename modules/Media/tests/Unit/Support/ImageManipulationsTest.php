...
describe('ImageManipulations', function () {
    ...
    it('rejects non-string filters', function () {
    ...
    it('applies blur and sharpen within bounds', function () {
        $result = ImageManipulations::apply(manipImage(), ['blur' => 5, 'sharpen' => 3]);

        expect((string) $result)->not->toBeEmpty();
    });

    it('rejects non-integer blur level', function () {
    ...
    it('rejects out of bounds blur level', function () {
    ...
    it('rejects out of bounds sharpen level', function () {
    ...
    it('applies rotate with numeric angle', function () {
        $result = ImageManipulations::apply(manipImage(), ['rotate' => 90]);

        expect((string) $result)->not->toBeEmpty();
    });

    it('rejects non-numeric rotate angle', function () {
    ...
    it('returns the image unchanged when no manipulations are present', function () {
