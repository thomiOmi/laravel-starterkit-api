...
test('returns basic data without title or detail', function () {
...
test('includes title and detail when provided', function () {
...
test('returns no content for 204 status', function () {
...
test('returns no content for 205 status', function () {
...
test('includes pagination meta for LengthAwarePaginator', function () {
    $items = [['id' => 1], ['id' => 2]];
...
test('includes pagination meta for simple Paginator', function () {
    $items = [['id' => 1], ['id' => 2]];
...
test('includes pagination meta for CursorPaginator', function () {
    $items = [['id' => 1]];
...
test('resolves data from ResourceCollection', function () {
...
test('filters protected keys from extra data', function () {
...
test('paginates with ResourceCollection containing paginator', function () {
    $items = [['id' => 1]];
