...
| [adr/](adr/README.md) | Architecture Decision Records: 22 decisions with rationale (Nygard format) |
...
| [module-generator.md](module-generator.md) | `make:module` usage and module scaffolding |
